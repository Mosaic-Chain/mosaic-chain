...
impl<T: sdk::frame_system::Config> WeightInfo for Weights<T> {
	...
	fn add_registrar(r: u32, ) -> Weight {
		...
		Weight::from_parts(8_222_112, 3310)
			// Standard Error: 927
			.saturating_add(Weight::from_parts(89_777, 0).saturating_mul(r.into()))
	...
	fn set_identity(r: u32, ) -> Weight {
		...
		Weight::from_parts(47_073_519, 6014)
			// Standard Error: 4_015
			.saturating_add(Weight::from_parts(157_454, 0).saturating_mul(r.into()))
	...
	fn set_subs_new(s: u32, ) -> Weight {
		...
		Weight::from_parts(27_649_056, 6014)
			// Standard Error: 35_849
			.saturating_add(Weight::from_parts(4_495_251, 0).saturating_mul(s.into()))
	...
	fn set_subs_old(p: u32, ) -> Weight {
		...
		Weight::from_parts(27_123_374, 6014)
			// Standard Error: 34_376
			.saturating_add(Weight::from_parts(2_172_585, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	...
	fn clear_identity(r: u32, s: u32, ) -> Weight {
		...
		Weight::from_parts(33_755_216, 5542)
			// Standard Error: 4_439
			.saturating_add(Weight::from_parts(173_762, 0).saturating_mul(r.into()))
			// Standard Error: 8_405
			.saturating_add(Weight::from_parts(1_766_422, 0).saturating_mul(s.into()))
	...
	fn request_judgement(r: u32, ) -> Weight {
		...
		Weight::from_parts(41_313_953, 5542)
			// Standard Error: 4_536
			.saturating_add(Weight::from_parts(143_279, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Identity::IdentityOf` (r:1 w:1)
	...
	fn cancel_request(r: u32, ) -> Weight {
		...
		Weight::from_parts(39_276_754, 5542)
			// Standard Error: 2_800
			.saturating_add(Weight::from_parts(25_647, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Identity::Registrars` (r:1 w:1)
	...
	fn set_fee(r: u32, ) -> Weight {
		...
		Weight::from_parts(6_082_688, 3310)
			// Standard Error: 1_418
			.saturating_add(Weight::from_parts(78_431, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Identity::Registrars` (r:1 w:1)
	...
	fn set_account_id(r: u32, ) -> Weight {
		...
		Weight::from_parts(6_141_507, 3310)
			// Standard Error: 950
			.saturating_add(Weight::from_parts(75_835, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Identity::Registrars` (r:1 w:1)
	...
	fn set_fields(r: u32, ) -> Weight {
		...
		Weight::from_parts(6_020_493, 3310)
			// Standard Error: 1_234
			.saturating_add(Weight::from_parts(89_051, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Identity::Registrars` (r:1 w:0)
	...
	fn provide_judgement(r: u32, ) -> Weight {
		...
		Weight::from_parts(38_224_109, 5542)
			// Standard Error: 3_662
			.saturating_add(Weight::from_parts(61_789, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Identity::SubsOf` (r:1 w:1)
	...
	fn kill_identity(r: u32, s: u32, ) -> Weight {
		...
		Weight::from_parts(41_351_119, 5542)
			// Standard Error: 3_473
			.saturating_add(Weight::from_parts(154_585, 0).saturating_mul(r.into()))
			// Standard Error: 6_576
			.saturating_add(Weight::from_parts(1_686_379, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
	...
	fn add_sub(s: u32, ) -> Weight {
		...
		Weight::from_parts(36_221_906, 6014)
			// Standard Error: 11_725
			.saturating_add(Weight::from_parts(207_756, 0).saturating_mul(s.into()))
	...
	fn rename_sub(s: u32, ) -> Weight {
		...
		Weight::from_parts(17_737_709, 5542)
			// Standard Error: 4_334
			.saturating_add(Weight::from_parts(82_642, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Identity::IdentityOf` (r:1 w:0)
	...
	fn remove_sub(s: u32, ) -> Weight {
		...
		Weight::from_parts(38_281_893, 6014)
			// Standard Error: 5_479
			.saturating_add(Weight::from_parts(132_437, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(5_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Identity::SuperOf` (r:1 w:1)
	...
	fn quit_sub(s: u32, ) -> Weight {
		...
		Weight::from_parts(29_262_665, 6014)
			// Standard Error: 4_895
			.saturating_add(Weight::from_parts(110_109, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(5_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn remove_username_authority() -> Weight {
		...
		Weight::from_parts(9_072_000, 3517)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Identity::AuthorityOf` (r:1 w:1)
	...
	fn set_username_for(_p: u32, ) -> Weight {
		...
		//  Measured:  `182`
		//  Estimated: `3593`
		// Minimum execution time: 60_445_000 picoseconds.
		Weight::from_parts(77_105_924, 3593)
			.saturating_add(T::DbWeight::get().reads(5_u64))
	...
	fn accept_username() -> Weight {
		...
		Weight::from_parts(19_878_000, 3567)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `Identity::PendingUsernames` (r:1 w:1)
	...
	fn remove_expired_approval(_p: u32, ) -> Weight {
		...
		Weight::from_parts(71_196_118, 3593)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn set_primary_username() -> Weight {
		...
		Weight::from_parts(12_067_000, 3563)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Identity::UsernameInfoOf` (r:1 w:0)
	...
	fn unbind_username() -> Weight {
		...
		Weight::from_parts(17_634_000, 3563)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Identity::UnbindingUsernames` (r:1 w:1)
	...
	fn remove_username() -> Weight {
		...
		Weight::from_parts(21_880_000, 3563)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `Identity::UsernameInfoOf` (r:1 w:1)
	...
	fn kill_username(_p: u32, ) -> Weight {
		...
		Weight::from_parts(40_275_030, 3593)
			.saturating_add(T::DbWeight::get().reads(5_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
	}
	...
	fn migration_v2_authority_step() -> Weight {
		...
		Weight::from_parts(8_091_000, 6087)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn migration_v2_username_step() -> Weight {
		...
		Weight::from_parts(8_161_000, 6099)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn migration_v2_identity_step() -> Weight {
		...
		Weight::from_parts(22_241_000, 10094)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn migration_v2_pending_username_step() -> Weight {
		...
		Weight::from_parts(7_060_000, 6144)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn migration_v2_cleanup_authority_step() -> Weight {
		...
		Weight::from_parts(10_394_000, 6044)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn migration_v2_cleanup_username_step() -> Weight {
		...
		Weight::from_parts(9_464_000, 6136)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}
